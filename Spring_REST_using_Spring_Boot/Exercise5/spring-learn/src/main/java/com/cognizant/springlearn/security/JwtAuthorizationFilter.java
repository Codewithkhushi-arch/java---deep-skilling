...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res,
        ...
        if (header == null || !header.startsWith("Bearer ")) {
            LOGGER.info("Authorization header missing or invalid format; proceeding with chain");
        ...
        if (authentication != null) {
            ...
            LOGGER.info("Authentication set successfully for user: {}", authentication.getPrincipal());
        } else {
    ...
    private UsernamePasswordAuthenticationToken getAuthentication(HttpServletRequest request) {
        ...
        if (token != null) {
            try {
                ...
                LOGGER.debug("Username from token: {}", user);
                if (user != null) {
        ...
        LOGGER.info("END getAuthentication - No token found");
        return null;
    }
}

...
public class EmployeeManagementSystemApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        System.out.println("\n\n=======================================================");
        System.out.println("  STARTING EMPLOYEE SYSTEM - EXERCISE 9 RUNNER    ");
        System.out.println("=======================================================\n");
        System.out.println("[Exercise 9] Multi-datasource configuration");
        ...
        long logCount = employeeService.getAuditLogCount();
        System.out.println("Verified Secondary Database logs count: " + logCount);

        System.out.println("\n=======================================================");
        System.out.println("  EXERCISE 9 RUN COMPLETED SUCCESSFULLY  ");
        System.out.println("=======================================================\n");
    }
}

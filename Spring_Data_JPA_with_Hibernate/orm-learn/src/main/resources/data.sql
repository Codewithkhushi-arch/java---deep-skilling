-- Seed data for ormlearn database
...
INSERT INTO department (dp_id, dp_name) VALUES (2, 'Payroll');
INSERT INTO department (dp_id, dp_name) VALUES (3, 'Admin');

-- Employee Table Inserts
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (1, 'John Doe', 5000.00, true, '1990-01-01', 2);
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (2, 'Alice Smith', 6000.00, true, '1992-05-15', 3);
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (3, 'Bob Johnson', 4000.00, false, '1995-10-10', 1);
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (4, 'Charlie Brown', 4500.00, true, '1994-08-20', 2);
...
INSERT INTO skill (sk_id, sk_name) VALUES (4, 'C++');

-- Employee Skill Mapping Table Inserts
INSERT INTO employee_skill (es_id, es_em_id, es_sk_id) VALUES (1, 1, 1);
INSERT INTO employee_skill (es_id, es_em_id, es_sk_id) VALUES (2, 1, 2);
INSERT INTO employee_skill (es_id, es_em_id, es_sk_id) VALUES (3, 2, 3);
INSERT INTO employee_skill (es_id, es_em_id, es_sk_id) VALUES (4, 3, 1);
INSERT INTO employee_skill (es_id, es_em_id, es_sk_id) VALUES (5, 3, 4);
INSERT INTO employee_skill (es_id, es_em_id, es_sk_id) VALUES (6, 4, 2);
INSERT INTO employee_skill (es_id, es_em_id, es_sk_id) VALUES (7, 4, 3);

-- Quiz Tables Inserts
INSERT INTO users (us_id, us_name) VALUES (1, 'Trainee User');
...
INSERT INTO options (op_id, op_qn_id, op_text, op_score, op_is_correct) VALUES (1, 1, '.xhtm', 0.0, false);
INSERT INTO options (op_id, op_qn_id, op_text, op_score, op_is_correct) VALUES (2, 1, '.ht', 0.0, false);
INSERT INTO options (op_id, op_qn_id, op_text, op_score, op_is_correct) VALUES (3, 1, '.html', 1.0, true);
INSERT INTO options (op_id, op_qn_id, op_text, op_score, op_is_correct) VALUES (4, 1, '.htmx', 0.0, false);

-- Options for Question 2
INSERT INTO options (op_id, op_qn_id, op_text, op_score, op_is_correct) VALUES (5, 2, '5', 0.0, false);
INSERT INTO options (op_id, op_qn_id, op_text, op_score, op_is_correct) VALUES (6, 2, '3', 0.0, false);
INSERT INTO options (op_id, op_qn_id, op_text, op_score, op_is_correct) VALUES (7, 2, '4', 0.0, false);
INSERT INTO options (op_id, op_qn_id, op_text, op_score, op_is_correct) VALUES (8, 2, '6', 1.0, true);

-- Options for Question 3
INSERT INTO options (op_id, op_qn_id, op_text, op_score, op_is_correct) VALUES (9, 3, 'false', 0.0, false);
INSERT INTO options (op_id, op_qn_id, op_text, op_score, op_is_correct) VALUES (10, 3, 'true', 1.0, true);

-- Options for Question 4
INSERT INTO options (op_id, op_qn_id, op_text, op_score, op_is_correct) VALUES (11, 4, '''John''', 0.5, true);
INSERT INTO options (op_id, op_qn_id, op_text, op_score, op_is_correct) VALUES (12, 4, 'John', 0.0, false);
INSERT INTO options (op_id, op_qn_id, op_text, op_score, op_is_correct) VALUES (13, 4, '"John"', 0.5, true);
INSERT INTO options (op_id, op_qn_id, op_text, op_score, op_is_correct) VALUES (14, 4, '/John/', 0.0, false);
...
-- For Q1, option 3 (.html) is selected
...
-- For Q2, option 6 (3) is selected (score 0.0)
...
-- For Q3, option 10 (true) is selected
...
-- For Q4, option 11 ('John') is selected

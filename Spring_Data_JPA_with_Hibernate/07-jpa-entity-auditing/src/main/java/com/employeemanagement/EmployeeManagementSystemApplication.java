...
public class EmployeeManagementSystemApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        System.out.println("\n\n=======================================================");
        System.out.println("  STARTING EMPLOYEE SYSTEM - EXERCISE 7 RUNNER    ");
        System.out.println("=======================================================\n");
        ...
        System.out.println("Saved department: " + engineering.getName());
        System.out.println("  Created By: " + engineering.getCreatedBy());
        System.out.println("  Created Date: " + engineering.getCreatedDate());
        ...
        System.out.println("  Created By: " + emp.getCreatedBy());
        System.out.println("  Created Date: " + emp.getCreatedDate());

        System.out.println("\n=======================================================");
        System.out.println("  EXERCISE 7 RUN COMPLETED SUCCESSFULLY  ");
        System.out.println("=======================================================\n");
    }
}
